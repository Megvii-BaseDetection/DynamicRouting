...
def generic_activation_jit(
    op_name: str
) -> typing.Callable[[typing.List[object], typing.List[object]],
                     typing.Counter[str]]:
    """
...
def addmm_flop_jit(inputs: typing.List[object],
...
def conv_flop_jit(inputs: typing.List[object],
                  outputs: typing.List[object]) -> typing.Counter[str]:
    """
...
def einsum_flop_jit(inputs: typing.List[object],
                    outputs: typing.List[object]) -> typing.Counter[str]:
    """
...
def matmul_flop_jit(inputs: typing.List[object],
                    outputs: typing.List[object]) -> typing.Counter[str]:
    """
...
def batchnorm_flop_jit(inputs: typing.List[object],
                       outputs: typing.List[object]) -> typing.Counter[str]:
    """
