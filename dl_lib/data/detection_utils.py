...
from dl_lib.structures import (BitMasks, Boxes, BoxMode, Instances, Keypoints,
                               PolygonMasks)
...
def build_transform_gen(cfg, is_train):
    ...
    Args:
        cfg (Config): cfg.INPUT.TRAIN_PIPELINES and cfg.INPUT.TEST_PIPELINES are used here
        is_train: If is_train, cfg.INPUT.TRAIN_PIPELINES will be used.
